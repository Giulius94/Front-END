...
let sum2 = arr1.reduce((save,value) => save + value,0);
console.log(sum2)
...
console.log(arr2)
let str3 = arr2.map(val2 => val2.length)
console.log(str3)
...
console.log("il film più vecchio è " + filmPiuVecchio + " uscito nell'anno " + vecchio);
